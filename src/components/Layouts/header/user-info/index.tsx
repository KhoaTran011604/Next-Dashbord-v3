...
export function UserInfo() {
  ...
  return (
    <Dropdown isOpen={isOpen} setIsOpen={setIsOpen}>
      ...
      <DropdownContent
        className="border border-stroke bg-white shadow-md dark:border-dark-3 dark:bg-gray-800 dark:bg-gray-dark dark:text-white/90 min-[230px]:min-w-[17.5rem]"
        align="end"
      >
        ...
        <figure className="flex items-center gap-2.5 px-5 py-3.5">
          ...
          <figcaption className="space-y-1 text-base font-medium">
            ...
            <div className="leading-none text-gray-6">{auth?.user?.email}</div>
          </figcaption>
        </figure>
